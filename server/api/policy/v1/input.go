...
type GetInputPolicyReq struct {
	g.Meta `path:"/input"  tags:"策略管理" method:"get" summary:"获取入站策略"`
}
...
type AddInputPolicyReq struct {
	g.Meta `path:"/input"  tags:"策略管理" method:"post" summary:"添加入站策略"`
...
type ReplaceInputPolicyReq struct {
	g.Meta   `path:"/input/:id"  tags:"策略管理" method:"put" summary:"修改入站策略"`
...
type ChangeInputPolicyPositionReq struct {
	g.Meta   `path:"/input/position/:id"  tags:"策略管理" method:"put" summary:"修改入站策略位置"`
	ID       int64 `json:"id" path:"id" example:"1"`
	Add      bool  `json:"add"`      // 使用add 还是insert
...
type DeleteInputPolicyReq struct {
	g.Meta `path:"/input/:id"  tags:"策略管理" method:"delete" summary:"删除入站策略"`
	ID     int64 `json:"id" path:"id" example:"1"`
}
