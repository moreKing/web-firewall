...
func (c *ControllerV1) ChangeDnatPolicyPosition(ctx context.Context, req *v1.ChangeDnatPolicyPositionReq) (res *v1.ChangeDnatPolicyPositionRes, err error) {
