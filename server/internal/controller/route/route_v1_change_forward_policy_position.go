...
func (c *ControllerV1) ChangeForwardPolicyPosition(ctx context.Context, req *v1.ChangeForwardPolicyPositionReq) (res *v1.ChangeForwardPolicyPositionRes, err error) {
