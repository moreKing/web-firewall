...
func (c *ControllerV1) ChangeInputLimitPolicyPosition(ctx context.Context, req *v1.ChangeInputLimitPolicyPositionReq) (res *v1.ChangeInputLimitPolicyPositionRes, err error) {
	...
	var tmp entity.InputLimitRules
