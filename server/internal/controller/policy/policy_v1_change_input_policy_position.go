...
func (c *ControllerV1) ChangeInputPolicyPosition(ctx context.Context, req *v1.ChangeInputPolicyPositionReq) (res *v1.ChangeInputPolicyPositionRes, err error) {
