...
func (c *ControllerV1) ChangeOutputLimitPolicyPosition(ctx context.Context, req *v1.ChangeOutputLimitPolicyPositionReq) (res *v1.ChangeOutputLimitPolicyPositionRes, err error) {
	...
	var tmp entity.OutputLimitRules
